...
abstract public class ReviewFetchDATA extends AsyncTask<String ,Void, List<ReviewsMODEL> > {
...
//       dialog.show();
    ...
    protected List<ReviewsMODEL> doInBackground(String... strings) {
        ...
        try {
            ...
            URL url = new URL(BASE_URL + id +  "/reviews" +API_KEY);
...
//                        }
    ...
    @Override
   abstract protected void onPostExecute(final List<ReviewsMODEL> result );
